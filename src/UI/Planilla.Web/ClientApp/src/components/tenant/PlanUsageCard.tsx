...
export default function PlanUsageCard() {
  ...
  if (isLoading) {
    return (
      <div className="bg-navy-900 border border-navy-700 rounded-lg shadow-lg shadow-black/20 p-6">
  ...
  return (
    <div className="bg-navy-900 border border-navy-700 rounded-lg shadow-lg shadow-black/20 overflow-hidden">
      {/* Header */}
      ...
      {planUsage.shouldUpgrade && planUsage.upgradeMessage && (
        <div className="bg-amber-500/15 border-l-4 border-amber-500 p-4">
          <div className="flex items-center gap-2">
            <AlertTriangle className="w-5 h-5 text-amber-400 flex-shrink-0" />
            <p className="text-amber-300 font-medium">{planUsage.upgradeMessage}</p>
          </div>
        </div>
      )}
      ...
      <div className="border-t border-navy-700 p-6">
        <h4 className="font-semibold text-gray-300 mb-4">Características del Plan</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {planUsage.features.map((feature) => (
            ...
            >
              ...
              <span className={feature.isAvailable ? 'text-gray-300' : 'text-gray-500 line-through'}>
                {feature.featureName}
              </span>
            </div>
          ))}
